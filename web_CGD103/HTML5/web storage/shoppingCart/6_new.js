...
function doFirst(){
	let itemString = storage['addItemList']  //或這樣寫  let itemString = storage.getItem('addItemList')
    let items = itemString.substr(0, itemString.length - 2).split(', ')
    //console.log(items)  // (3) ['A1002', 'A1003', 'A1001']

    newDiv = document.createElement('div')
    newTable = document.createElement('table')

    //將 table 放進 div， 再將 div 放進放進 cartList
